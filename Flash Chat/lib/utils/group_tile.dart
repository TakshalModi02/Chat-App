...
class GroupTile extends StatelessWidget {
  ...
  const GroupTile({super.key, required this.groupName, required this.senderUserMap,required this.groupTitle, required this.controller, this.isSearch=false});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: MaterialButton(
        onPressed: (){
          print(groupName);
          Navigator.push(context, MaterialPageRoute(builder: (context)=> GroupChatScreen(groupName: groupName, senderName: senderUserMap!['Name'],groupTitle: groupTitle, senderUid: senderUserMap!['uid'],currUserMap: senderUserMap!, controller: controller)));
        },
