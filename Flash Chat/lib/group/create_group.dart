                ...
                Padding(
                  ...
                  child: IconButton(
                    onPressed: () {
                      ...
                      firestore.collection('group').doc(widget.currUserMap['uid']+group.text).set({
                        'Group Name': group.text,
                        'Admin': widget.currUserMap['uid']
                      });
                      firestore.collection('group').doc(widget.currUserMap['uid']+group.text).collection('members').doc('widget.currUserMap["uid"]').set(widget.currUserMap);
